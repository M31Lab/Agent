...
export class DiagnosticsMonitoringService implements vscode.Disposable {
    ...
    private constructor(context: ExtensionContext, options: Partial<DiagnosticsMonitoringOptions> = {}) {
    ...
    private shouldIncludeDiagnostic(diagnostic: vscode.Diagnostic): boolean {
        ...
        if (diagnostic.severity === vscode.DiagnosticSeverity.Information && this.options.includeInformation) {
            return true;
        }
