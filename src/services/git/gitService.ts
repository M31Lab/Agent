...
export class GitService implements vscode.Disposable {
  ...
  public async generateCommitMessage(
    ...
    let prompt =
      'Generate a concise, informative Git commit message based on the following staged changes:\n\n';
    ...
    if (options.includeDetails) {
      prompt +=
        '- Include a more detailed explanation after the first line, separated by a blank line\n';
    }
        ...
        [
          {
            ...
            content:
              'You are a helpful assistant that generates concise, clear git commit messages based on code changes.',
          },
          {
            role: ChatRole.User,
            content: prompt,
