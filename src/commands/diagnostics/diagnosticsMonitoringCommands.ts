...
import {
  ...
  FileWithDiagnostics,
} from '../../services/diagnostics/diagnosticsMonitoringService';
  ...
  disposables.push(
    vscode.commands.registerCommand('m31-agent.diagnostics.showAll', async () => {
      try {
        ...
        const __totalIssues =
          errorCount.errors + errorCount.warnings + errorCount.information + errorCount.hints;
    ...
    vscode.commands.registerCommand('m31-agent.diagnostics.updateOptions', async () => {
      try {
        ...
        diagnosticsService.updateOptions({
          includeInformation: selectedOptions.some(
            (o) => o.label === 'Include Information Level Diagnostics'
          ),
          includeHints: selectedOptions.some((o) => o.label === 'Include Hint Level Diagnostics'),
          trackHistory: selectedOptions.some((o) => o.label === 'Track Diagnostic History'),
        });
