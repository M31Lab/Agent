...
} from './defaults/defaultConfiguration';
...
export class ConfigurationManager {
  ...
  public getFullConfiguration(): ExtensionConfiguration {
    return {
      ...
      modelId:
        this.get<string>(ConfigurationKeys.MODEL_ID) ||
        DefaultConfiguration[ConfigurationKeys.MODEL_ID],
      temperature:
        this.get<number>(ConfigurationKeys.TEMPERATURE) ||
        DefaultConfiguration[ConfigurationKeys.TEMPERATURE],
      maxTokens:
        this.get<number>(ConfigurationKeys.MAX_TOKENS) ||
        DefaultConfiguration[ConfigurationKeys.MAX_TOKENS],
      logLevel:
        this.get<string>(ConfigurationKeys.LOG_LEVEL) ||
        DefaultConfiguration[ConfigurationKeys.LOG_LEVEL],
      enableTelemetry:
        this.get<boolean>(ConfigurationKeys.ENABLE_TELEMETRY) ??
        DefaultConfiguration[ConfigurationKeys.ENABLE_TELEMETRY],
      requireConfirmation:
        this.get<boolean>(ConfigurationKeys.REQUIRE_CONFIRMATION) ??
        DefaultConfiguration[ConfigurationKeys.REQUIRE_CONFIRMATION],
      ...
      showWelcomeOnStartup:
        this.get<boolean>('showWelcomeOnStartup') ?? DEFAULT_SHOW_WELCOME_ON_STARTUP,
    };
  }
