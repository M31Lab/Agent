...
export class ConfigurationValidator {
  ...
  public static validateAiModelConfiguration(
    config: Partial<AiModelConfiguration>
  ): AiModelConfiguration {
    return {
      ...
      frequencyPenalty:
        config.frequencyPenalty !== undefined
          ? this.validateNumber(config.frequencyPenalty, 0, 0, 2)
          : undefined,
      presencePenalty:
        config.presencePenalty !== undefined
          ? this.validateNumber(config.presencePenalty, 0, 0, 2)
          : undefined,
      availableModels: config.availableModels || [],
    };
  }

  public static validateLoggingConfiguration(
  ...
  public static validateSecurityConfiguration(
    config: Partial<SecurityConfiguration>
  ): SecurityConfiguration {
    return {
      requireConfirmation: this.validateBoolean(
  ...
  public static validateTelemetryConfiguration(
  ...
  public static validateUserInterfaceConfiguration(
    config: Partial<UserInterfaceConfiguration>
  ): UserInterfaceConfiguration {
    return {
  ...
  public static validateCompletionConfiguration(
    config: Partial<CompletionConfiguration>
  ): CompletionConfiguration {
    return {
  ...
  public static validateFullConfiguration(
  ...
  private static validateLogLevel(
    value: unknown,
    defaultValue: 'debug' | 'info' | 'warning' | 'error' | 'none'
  ...
  private static validatePanelPosition(
    value: unknown,
