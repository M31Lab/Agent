# M31-Agent: AI-Powered Coding Assistant for VS Code
...
M31-Agent is a powerful AI coding assistant for Visual Studio Code that revolutionizes the way developers interact with their codebase. By harnessing the advanced capabilities of OpenRouter AI, this extension brings natural language understanding directly into your coding workflow, enabling intelligent code generation, explanation, navigation, and much more.

Named after the Andromeda Galaxy (M31), this agent serves as your personal guide through the vast universe of code, helping you navigate complex projects, understand unfamiliar codebases, and accelerate your development workflow. The extension seamlessly integrates with VS Code, providing context-aware assistance that adapts to your specific coding environment and needs.

M31-Agent is designed for developers across all experience levels, from beginners looking to learn and understand code better, to seasoned professionals seeking to automate repetitive tasks and navigate large codebases more efficiently. With its intuitive interface and powerful AI capabilities, M31-Agent becomes an indispensable companion for modern software development.

## Key Features

M31-Agent offers a comprehensive suite of AI-powered features designed to enhance productivity and understanding in your development workflow:

### Core Features

- **AI Chat**: Engage in natural language conversations with the AI about your code and programming problems directly within your editor. The chat interface supports both quick inline questions and more detailed discussions in a dedicated panel.

- **Code Generation**: Generate code snippets, complete functions, or entire modules based on natural language descriptions. The AI understands context from your current file and project, producing code that follows your existing patterns and conventions.

- **Code Explanation**: Select any code segment and get a detailed explanation of what it does, how it works, and why certain approaches were taken. Explanations can be tailored to different knowledge levels, from beginner to expert.

- **Terminal Commands**: Run or generate terminal commands using natural language descriptions. Save time by asking for complex commands rather than having to remember syntax and options.

- **Codebase Navigation**: Easily find relevant files, functions, and classes in your project. Ask questions about your codebase structure and get intelligent navigation suggestions.

- **Multi-Language Support**: Works with all major programming languages and frameworks, adapting its assistance to the specific language and syntax you're working with.

### Advanced Features

- **Code Refactoring**: Get suggestions for improving code quality, performance, and readability. The AI can identify potential refactoring opportunities and implement the changes for you.

- **Debugging Assistance**: Describe problems in natural language and receive debugging suggestions, potential fixes, and explanations of error messages.

- **Documentation Generation**: Automatically generate documentation for functions, classes, and modules based on the code itself, saving time and ensuring consistent documentation.

- **Test Generation**: Create unit tests and test cases based on your implementation code, helping ensure proper test coverage.

- **Context-Aware Completions**: Beyond standard code completion, M31-Agent offers intelligent suggestions based on your broader codebase and common patterns.

- **Learning Resources**: Get links to relevant documentation, tutorials, and examples related to the code you're working with or problems you're trying to solve.
...
| **Code Generation** | ✅ Extensive | ✅ Extensive | ✅ Limited | ✅ Limited |
| **Natural Language Chat** | ✅ Advanced | ✅ Basic | ❌ No | ❌ No |
| **Code Explanation** | ✅ Comprehensive | ✅ Basic | ❌ No | ✅ Basic |
| **Terminal Command Generation** | ✅ Yes | ❌ No | ❌ No | ❌ No |
...
M31-Agent stands out with its flexible AI model selection through OpenRouter, comprehensive natural language capabilities, and unique features like terminal command generation and advanced codebase navigation.

## Installation

M31-Agent can be installed directly from the Visual Studio Code Marketplace through multiple methods:
...
### Method 2: Install via VS Code Command Palette
...
3. **Conflicting Extensions**: Temporarily disable other AI coding assistants to prevent conflicts
...
Getting started with M31-Agent is straightforward. Follow these steps to begin enhancing your coding experience:
...
M31-Agent leverages OpenRouter AI to provide access to multiple state-of-the-art language models, giving you flexibility and power in your coding assistant.

### What is OpenRouter?

OpenRouter is an API gateway service that provides unified access to various AI models from different providers including OpenAI, Anthropic, Google, and more. This allows M31-Agent to offer you a choice of models, each with their own strengths and capabilities.

### Supported Models

M31-Agent supports the following models through OpenRouter:
...
- **Anthropic Claude 3 Sonnet**: Balanced capability and performance for coding tasks
...
When using M31-Agent, be aware of OpenRouter's pricing structure:
...
- **Interactive Elements**: Clickable actions and code snippets that can be inserted into your editor
- **Context Display**: Visibility into what code context the AI is considering
...
- **Refactor Selection**: Receive suggestions for improving selected code
...
- **Settings Configuration**: Visual interface for adjusting all M31-Agent settings
...
- **Conversation Management**: Create, rename, and delete conversation threads
...
- **Framework-Specific Generation**: Tailored to popular frameworks like React, Angular, Vue, Express, Django, etc.
...
- **Parameter Customization**: Fine-tune generated commands before running
- **Execution Monitoring**: Track command progress and output
- **Error Recovery**: Get help understanding and fixing command errors

#### Safety Features

- **Confirmation Required**: Explicitly approve commands before execution
- **Destructive Command Warning**: Extra confirmation for potentially dangerous operations
- **Permission Checking**: Verification of necessary permissions before execution
- **Execution Preview**: See what will happen before commands run
...
- **Symbol Browser**: Hierarchical view of classes, functions, and variables
...
- **History Tracking**: Navigate through previously visited locations
...
Improve your code quality with AI-assisted refactoring:

#### Refactoring Capabilities

- **Code Smell Detection**: Identification of common anti-patterns and code smells
- **Automated Fixes**: One-click solutions for common issues
- **Performance Optimizations**: Suggestions for improving execution speed and memory usage
- **Modernization**: Update legacy code to use modern language features and patterns
- **Style Consistency**: Ensure code follows project conventions and style guides

#### Refactoring Types

- **Extract Method/Component**: Split large functions into smaller, reusable pieces
- **Rename Refactoring**: Intelligent renaming that updates all references
- **Type Enhancement**: Add or improve type annotations and generics
- **Null Safety**: Improve handling of null/undefined values
- **Async/Await Conversion**: Transform callback or promise chains into async/await

#### Safety Features

- **Preview Changes**: See all proposed modifications before applying them
- **Test Integration**: Run tests automatically after refactoring to ensure correctness
- **Reversible Operations**: Easily undo applied refactorings
- **Incremental Application**: Apply refactorings in stages for complex changes
...
Get help solving complex bugs and understanding error messages:

#### Debug Features

- **Error Analysis**: Plain-language explanations of error messages
- **Root Cause Identification**: Trace errors to their source
- **Fix Suggestions**: Multiple approaches to resolve the identified issues
- **Runtime Behavior Analysis**: Help understanding unexpected program behavior
- **Edge Case Identification**: Discovery of boundary conditions that might cause problems

#### Integration Points

- **VS Code Debugger Enhancement**: Additional insights during debugging sessions
- **Stack Trace Analysis**: Interpretation of complex stack traces
- **Log Parsing**: Extract meaningful information from application logs
- **Test Failure Analysis**: Understand why specific tests are failing

#### Example Prompts

```
> Help me understand this TypeError that's occurring in my React component
```

```
> Debug why this API request is returning a 403 status
```
...
- **Architecture Documentation**: Describe system design and component interactions
...
- **Keyboard Shortcuts**: Customize keyboard shortcuts for all commands
...
- **VS Code Settings UI**: Access through the standard VS Code settings panel
- **JSON Configuration**: Edit settings.json directly for advanced configurations
- **Command Palette**: Quickly access common settings through dedicated commands
- **Configuration Wizard**: Interactive setup process for new installations
...
- **Haskell**: Support for pure functional programming concepts
...
- **SQL**: Support for multiple dialects (MySQL, PostgreSQL, SQLite, MS SQL)
- **GraphQL**: Schema definition and query optimization
...
- **Error Patterns**: Recognition of common errors and anti-patterns in each language
...
- **Custom Commands**: Define project-specific commands in settings
...
- **Pre-commit Code Review**: Get AI feedback before committing changes
...
- **Effort Estimation**: Get input on complexity and effort for development tasks
...
- **Risk Assessment**: Highlight potential technical risks in planned changes
...
- **Command Processors**: Implements specific commands like code generation and explanation
...
- **React**: Component-based UI for webview panels
...
- **Configurable Context**: Control exactly what files and information are included
...
- **Command Execution Confirmation**: Confirmation required before running commands
...
- **Vulnerability Checking**: Analysis of generated code for common security issues
...
- **GPT-4o**: OpenAI's most advanced model with superior coding capabilities
  ...
  - Limitations: Higher latency, more expensive
...
- **GPT-4 Turbo**: Powerful model with expanded context window
  ...
  - Limitations: Slightly less capable than GPT-4o
...
- **GPT-3.5 Turbo**: Fast and economical general-purpose model
  ...
  - Limitations: Less sophisticated reasoning, more likely to make mistakes
...
- **Claude 3 Opus**: Anthropic's most capable AI assistant
  ...
  - Limitations: Higher cost, not optimized for all programming languages
...
- **Claude 3 Sonnet**: Balanced performance and capabilities
  ...
  - Limitations: Less capable than Opus for very complex tasks
...
- **Claude 3 Haiku**: Fast and efficient assistant
  ...
  - Limitations: Limited complexity handling, shorter outputs
...
- **Gemini Pro**: Google's advanced AI model
  ...
  - Limitations: Smaller context window, less specialized for some programming languages
...
- **Moderate Tasks** (building a component, refactoring code): GPT-4 Turbo, Claude 3 Sonnet
- **Complex Tasks** (system design, security auditing): GPT-4o, Claude 3 Opus

#### Response Speed Requirements

- **Immediate Responses**: Claude 3 Haiku, GPT-3.5 Turbo
- **Balanced**: Claude 3 Sonnet, Gemini Pro
...
- **Workspace Indexing**: Codebase structure is indexed for faster navigation
...
- **Background Processing**: Heavy tasks run in background threads
...
- **Lazy Loading**: Components and features load only when needed
- **Resource Cleanup**: Proper disposal of unused resources
- **Throttling and Debouncing**: Prevention of excessive API calls

### Performance Monitoring

- **Response Time Tracking**: Monitoring of API and processing latency
...
- **Architecture Visualization**: AI-generated diagrams of code structure and flow
- **Natural Language Requirements**: Generate code from requirement descriptions
- **Automated Refactoring Suggestions**: Proactive code improvement recommendations
...
- **Email Support**: Contact us at support@m31-ai.com
